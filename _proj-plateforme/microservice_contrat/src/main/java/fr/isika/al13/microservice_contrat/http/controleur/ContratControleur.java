package fr.isika.al13.microservice_contrat.http.controleur;
...
import fr.isika.al13.microservice_contrat.dao.ContratRepository;
import fr.isika.al13.microservice_contrat.exception.ContratIntrouvableException;
...
//----------------------------------------TROUVE_CONTRAT_BY_ID----------------------------------------------------------------
	...
	public @ResponseBody Contrat getContratById(@PathVariable Integer id) {
